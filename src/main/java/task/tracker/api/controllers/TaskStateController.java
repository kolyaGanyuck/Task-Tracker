...
import task.tracker.api.dto.AckDto;
...
public class TaskStateController {
    ...
    public static final String UPDATE_TASK_STATE = "/api/projects/{task_state_id}";
    ...
    public TaskStateDto changeTaskPosition(
        ...
        if (optionalNewRightTaskState.isPresent()) {
            ...
            changeTaskState.setLeftTaskState(newRightTaskState);
        } else {
            changeTaskState.setRightTaskState(null);
